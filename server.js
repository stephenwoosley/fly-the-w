...
app.get("/scrape-facts", function (req, res) {
  ...
  request("http://www.chicagotribune.com/sports/baseball/cubs/ct-108-things-every-cubs-fan-should-know-story.html", function (error, response, html) {
    ...
    $("p").each(function (i, element) {
      ...
      facts.question = $(element).find("strong").text();
